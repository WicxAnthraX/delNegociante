...
insert into configuration(name,label,kind,val) value ("general_main_title","Titulo Principal",1,"delNegociante");
insert into configuration(name,label,kind,val) value ("general_main_email","Email Principal",1,"admin@delnegociante.com");
